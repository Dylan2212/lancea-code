  ...
  return (
    <div className="relative pb-32">
      ...
      <main className="overflow-hidden">
        <Hero/>
        <StepsSection/>
        <section className="flex mt-24 h-[600px] max-h-[600px] min-h-[600px] lg:h-auto lg:mt-32 justify-center gap-32 xl:mr-32 relative z-10 md:w-auto w-full lg-ml-0">
          <div className="relative z-10 md:mr-8">
            ...
            <ul className="md:mt-6 mt-12 min-h-[550px] h-[550px] max-h-[550px] lg:h-auto w-3/4 md:w-2/3 lg:w-5/6 xl:w-auto lg:mx-0 ml-auto mr-5 flex flex-col justify-around lg:block">
              <li>
                <div className="flex items-center gap-4 mb-5 md:mb-0">
                  ...
                  <div>
                    <p className="font-semibold text-xl">Ridiculously easy to use</p>
                    <p className="text-gray-600">No design skills. No code. No learning curve</p>
                  </div>
                </div>
              </li>
              <li>
              ...
              <li>
                <div className="flex items-center gap-4 mb-5 md:mb-0">
                  <Check className="hidden md:block min-w-16 max-w-16 md:min-w-16 md:max-w-16 lg:min-w-24 lg:max-w-24 h-24 text-purple-600"/> 
                  <div>
                    <p className="font-semibold text-xl">Clean, professional design</p>
                    <p className="text-gray-600">A focused one-page layout built to convert visitors into clients</p>
                  </div>
                </div>
              </li>
              <li>
                <div className="flex items-center gap-4 mb-5 md:mb-0">
                  <Check className="hidden md:block min-w-16 max-w-16 md:min-w-16 md:max-w-16 lg:min-w-24 lg:max-w-24 h-24 text-purple-600"/> 
                  <div>
                    <p className="font-semibold text-xl">Your own custom link</p>
                    <p className="text-gray-600">Share your work with a simple lancrly.com/yourname link</p>
                  </div>
                </div>
              </li>
            </ul>
        ...
        <section className="mt-32 lg:mt-20 relative z-10 pb-12">
          <div className="border-2 border-purple-600 rounded-xl shadow-2xl h-72 lg:h-60 p-6 w-11/12 md:w-2/3 lg:w-1/2 mx-auto flex flex-col justify-around items-center">
            <p className="text-3xl text-center">Create a Portfolio Clients Take Seriously</p>
