  ...
  return (
    ...
    ">
      <div className="w-[300px] relative aspect-[4/3]">
        ...
        <p className="absolute group-hover:bg-black transition-all duration-200 ease-in-out bottom-2 right-2 text-sm font-semibold text-white bg-black/75 rounded-full px-3 py-2">View Project</p>
      </div>
