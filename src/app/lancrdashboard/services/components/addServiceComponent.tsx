...
export default function AddServiceComponent ({ action, index }: AddServiceComponentProps) {
  ...
  const { saving, title, price, description, saveService } = serviceEditor
  ...
  return (
    <section className="pt-16 w-screen lg:w-full">
      <div>
        ...
        <button type="button" onClick={() => saveService(title, price, description, index)} className="rounded-md bg-purple-600 text-white hover:bg-purple-500 hov-standrd w-fit text-lg px-6 py-2 mr-6 lg:mr-0">
