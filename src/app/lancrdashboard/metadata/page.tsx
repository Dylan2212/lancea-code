...
export default function Page () {
  const { ogMetaData, searchMetaData, setOgMetaData, setSearchMetaData, saveMetaData, handleFileChange } = useMetaDataManager()
  ...
  return (
    <section className="pt-16 w-screen lg:w-full pb-12">
      ...
      <SearchData searchMetaData={searchMetaData} setSearchMetaData={setSearchMetaData} saveMetaData={saveMetaData}/>
      <OgData handleFileChange={handleFileChange} ogMetaData={ogMetaData} setOgMetaData={setOgMetaData} saveMetaData={saveMetaData}/>
    </section>
  )
}