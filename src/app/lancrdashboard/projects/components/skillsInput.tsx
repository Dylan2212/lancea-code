...
export default function SkillsInput ({ enteredSkill, onFocus, onBlur, onKeyDown, newInput, isFocused, results, input, ghostSuggestion, maxSkills }: InputProps) {
  return (
    <div>
      ...
      {maxSkills && <p className="text-red-500 text-xs ml-2 my-0">Maximum skills reached</p>}
    </div>
  )
}