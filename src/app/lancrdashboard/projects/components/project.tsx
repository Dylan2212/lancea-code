  ...
  return (
    <div className="w-11/12 rounded-lg group mx-auto lg:mx-0 md:w-[300px]">
      <div className="relative aspect-[4/3] w-full">
        {project.cover?.coverUrl ? <Image alt="project cover" priority className={`object-cover image-crisp aspect-[4/3] rounded-lg shadow-md shadow-gray-400`} fill sizes="300px" src={project.cover.coverUrl} /> : null}
