"use client"
import { CircleUserRound, BriefcaseBusiness, MessageSquareText, LayoutGrid, Star } from "lucide-react"
...
export default function BottomNav () {
  ...
  return (
    ...
    ">
      ...
      <Link href="/lancrdashboard/services" className="h-11/12 mb-2 w-16 px-2 flex flex-col gap-1 items-center justify-center relative">
      ...
      <Link href="/lancrdashboard/testimonials" className="h-11/12 mb-2 w-16 px-2 flex flex-col gap-1 items-center justify-center relative">
