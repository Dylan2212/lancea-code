    ...
    <main className="w-full overflow-auto">
      ...
      <div className="w-3/4 mx-auto">
        <section className="lancr-add-edit-sect box-support">
          <p className="lancr-add-edit-sect-ttle">Add Images</p>
        ...
        <section className="lancr-add-edit-sect box-support">
          ...
          <div className="mt-6 mb-3 ml-2">
            ...
            <input className="lancr-add-edit-text-input" type="text" id="title-input" placeholder="Project title" />
        ...
        <section className="lancr-add-edit-sect box-support">
          <p className="lancr-add-edit-sect-ttle">Project Details</p>
        ...
        <section className="lancr-add-edit-sect box-support">
          <p className="lancr-add-edit-sect-ttle">Skills</p>
          ...
          <div className="mt-6 mb-3 ml-2">
            <input className="lancr-add-edit-text-input" type="text" id="title-input" placeholder="Add skills" />
        ...
        <section className="lancr-add-edit-sect box-support">
          <p className="lancr-add-edit-sect-ttle">Project Links</p>
          ...
          <div className="mt-6 mb-3 ml-2">
            ...
            <input className="lancr-add-edit-text-input" type="text" id="title-input" placeholder="https://example.com" />
